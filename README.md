...
**Главный результат работы — отрицательный.** Все 265 тестов проходят,
и одновременно в калькуляторе живёт дефект, роняющий расчёт исключением
примерно на 42 % реалистичных конфигураций кредита. Нашёлся он не тестами.
